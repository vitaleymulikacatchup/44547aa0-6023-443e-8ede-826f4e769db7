...
export const metadata: Metadata = {
  title: "SantoMonic Coffeeshop | Specialty Coffee",
  description: "Discover handcrafted specialty coffee and pastries at SantoMonic. Premium espresso drinks, cozy atmosphere, and exceptional service.",
  keywords: ["coffeeshop", "specialty coffee", "espresso", "cappuccino", "cafe", "coffee shop near me"],
  openGraph: {
    title: "SantoMonic Coffeeshop",
    description: "Discover handcrafted specialty coffee at SantoMonic. Premium espresso drinks and a welcoming atmosphere.",
    siteName: "SantoMonic",
    type: "website"
  },
  twitter: {
    ...
    title: "SantoMonic Coffeeshop | Specialty Coffee",
    description: "Experience the finest specialty coffee. Handcrafted espresso drinks in a warm, inviting space."
  }
};
